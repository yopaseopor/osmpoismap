...
style: function (feature) {
	...
	onClickEvent: function(evt, view, coordinateLL) {
		...
		//Openrouteservice
		show.append($('<a>').css('marginLeft', 5).attr({title: 'OpenRouteService', href: 'https://maps.openrouteservice.org/#/place/@' + coordinateLL[0] + ',' + coordinateLL[1] + ',' + Math.min(view.getZoom(), 18) , target: '_blank'}).html($('<img>').attr({src: imgSrc + 'ors_logo.png', height: 20, width: 20})));
