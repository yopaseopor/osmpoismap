...
//Mapcomplete editor
		...
		//Here WeGo
		open.append($('<a>').css('marginLeft', 5).attr({title: 'HERE', href: 'https://wego.here.com/?map=' + coordinateLL[1] + ',' + coordinateLL[0] + ',' + Math.min(view.getZoom(), 18) + ',normal', target: '_blank'}).html($('<img>').attr({src: imgSrc + 'here_logo.png', height: 20, width: 20})));
		//Google
		...
		//Bing
		open.append($('<a>').css('marginLeft', 5).attr({title: 'Bing Maps', href: 'https://www.bing.com/maps?' + coordinateLL[1] + ',' + coordinateLL[0] + Math.min(view.getZoom(), 21), target: '_blank'}).html($('<img>').attr({src: imgSrc + 'bing_logo.png', height: 20, width: 20})));
		//OSMAnd
